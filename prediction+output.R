...
# ----------------------
# 6. OPTIONAL: Stepwise model to refine variables
# ----------------------

# step_model <- step(dpoy_model, direction = "both")
# summary(step_model)

# ----------------------
# 7. Display top predictions for a specific year
# ----------------------
...
# ----------------------
# 8. Example: Show predictions for a given year
# ----------------------
